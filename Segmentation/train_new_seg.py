...
MODEL_NAME = "segmentation_model_5class_camvid+carla-1.pt"
PRINT_LOSS = False
GRAPH_LOSS = True
...
labels_dir = os.path.abspath("../data/camVid/processed/seg")
imgs_dir = os.path.abspath("../data/camVid/processed/rgb")
