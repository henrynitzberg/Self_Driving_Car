...
curr_dir = os.getcwd()
model_path = os.path.abspath("../models/driver_model-2.pt")
image_path = os.path.abspath("../data/01_labels_reduced_classes/00148.png")
...
image = image[:int((height / 5) * 4), int(width / 3):]
